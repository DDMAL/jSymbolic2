...
public class MIDIIntermediateRepresentationsTest {
    ...
    public void verticalIntervalChart() throws Exception {
        ...
        int[][] actual_pitch_tick = actual_representation.vertical_interval_chart;
        ...
        int[][] actual_pitch_more = actual_representation_more.vertical_interval_chart;
        ...
        int[][] actual_pitch_tracks = actual_representation_tracks.vertical_interval_chart;
