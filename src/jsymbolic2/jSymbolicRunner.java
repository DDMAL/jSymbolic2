...
public class jSymbolicRunner {
    ...
    private final static int RECOMMENDED_HEAP_SIZE = 1023;
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (heapSizeMegs > MIN_HEAP_SIZE) {
            ...
            ProcessBuilder pb = new ProcessBuilder("java","-Xmx" + RECOMMENDED_HEAP_SIZE + "m", "-classpath", classPath, "jsymbolic.Main");
