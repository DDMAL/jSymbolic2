...
public final class FeatureExtractorAccess
{
	...
	static
	{
		all_implemented_feature_extractors = new MIDIFeatureExtractor[]
		{
			...
			new MedianNumberOfIndependentVoicesFeature(),
			...
			new RelativeRangeOfHighestVoiceFeature(),
			new RelativeRangeIsolationOfHighestVoiceFeature(),
			new RelativeNoteDensityOfHighestVoiceFeature(),
			new RelativeSizeOfMelodicIntervalsInHighestVoiceFeature(),
			new RelativeNoteDurationsOfHighestVoiceFeature(),
			new RelativeRangeOfLowestVoiceFeature(),
			new RelativeRangeIsolationOfLowestVoiceFeature(),
			new RelativeNoteDensityOfLowestVoiceFeature(),
			new RelativeNoteDurationsOfLowestVoiceFeature(),
			new RelativeSizeOfMelodicIntervalsInLowestVoiceFeature(),
			new AverageRangeOfIndividualVoicesFeature(),
			new VoiceSeparationFeature(),
			new VariabilityOfVoiceSeparationFeature(),
			new VoiceOverlapFeature(),
			new VoiceCrossingFeature(),
			...
			new MostCommonMelodicInterval3GramTypeInHighestLineFeature(),
			new SecondMostCommonMelodicInterval3GramTypeInHighestLineFeature(),
			new PrevalenceOfMostCommonMelodicInterval3GramTypeInHighestLineFeature(),
			new PrevalenceOfSecondMostCommonMelodicInterval3GramTypeInHighestLineFeature(),
			new PrevalenceOfMedianMelodicInterval3GramTypeInHighestLineFeature(),
			new NumberOfDistinctMelodicInterval3GramTypesInHighestLineFeature(),
			new NumberOfRareMelodicInterval3GramTypesInHighestLineFeature(),
			new NumberOfCommonMelodicInterval3GramTypesInHighestLineFeature(),
			new NumberOfVeryCommonMelodicInterval3GramTypesInHighestLineFeature(),
			new PrevalenceOfMelodicInterval3GramTypesOccurringOnlyOnceInHighestLineFeature(),
            new PrevalenceOfRareMelodicInterval3GramTypesInHighestLineFeature(),
            new PrevalenceOfCommonMelodicInterval3GramTypesInHighestLineFeature(),
            new PrevalenceOfVeryCommonMelodicInterval3GramTypesInHighestLineFeature(),
			new MostCommonMelodicInterval3GramTypeInLowestLineFeature(),
			new SecondMostCommonMelodicInterval3GramTypeInLowestLineFeature(),
			new PrevalenceOfMostCommonMelodicInterval3GramTypeInLowestLineFeature(),
			new PrevalenceOfSecondMostCommonMelodicInterval3GramTypeInLowestLineFeature(),
			new PrevalenceOfMedianMelodicInterval3GramTypeInLowestLineFeature(),
			new NumberOfDistinctMelodicInterval3GramTypesInLowestLineFeature(),
			new NumberOfRareMelodicInterval3GramTypesInLowestLineFeature(),
			new NumberOfCommonMelodicInterval3GramTypesInLowestLineFeature(),
			new NumberOfVeryCommonMelodicInterval3GramTypesInLowestLineFeature(),
