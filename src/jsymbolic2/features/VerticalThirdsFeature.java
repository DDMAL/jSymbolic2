...
/**
 * A feature extractor that extracts the fraction of all vertical intervals that are thirds.
 *
 * <p>No extracted feature values are stored in objects of this class.
 *
 * @author Tristano Tenaglia
 */
public class VerticalThirdsFeature extends MIDIFeatureExtractor{
            ...
            throws Exception
    {
        ...
        double third_fraction = vertical_interval_chart[3] + vertical_interval_chart[4];
        return new double[]{third_fraction};
    }
}
