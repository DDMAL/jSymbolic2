...
/**
 * A feature extractor that extracts the fraction of vertical intervals
 ...
 */
public class PrevalenceOfMostCommonVerticalIntervalFeature extends MIDIFeatureExtractor {
    ...
    public PrevalenceOfMostCommonVerticalIntervalFeature()
    {
        ...
        dependencies = new String[]{"Vertical Interval Succession Wrapped", "Most Common Vertical Interval"};
        offsets = null;
    }
