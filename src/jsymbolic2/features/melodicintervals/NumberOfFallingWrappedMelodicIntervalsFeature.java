...
/**
 * A feature calculator that finds the number of falling wrapped melodic intervals that occur at least once in 
 * the piece.
 *
 * @author radamian
 */
public class NumberOfFallingWrappedMelodicIntervalsFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfFallingWrappedMelodicIntervalsFeature()
	{
		String name = "Number of Falling Wrapped Melodic Intervals";
		String code = "M-16";
