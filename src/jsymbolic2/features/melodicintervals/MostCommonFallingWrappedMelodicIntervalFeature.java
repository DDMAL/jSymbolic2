 ...
 * @author radamian
 */
public class MostCommonFallingWrappedMelodicIntervalFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public MostCommonFallingWrappedMelodicIntervalFeature()
	{
		String name = "Most Common Falling Wrapped Melodic Interval";
		String code = "M-8";
		String description = "Number of semitones corresponding to the most frequently occurring falling wrapped melodic interval.";
