...
/**
 * A feature calculator that finds the standard deviation of the wrapped melodic intervals in the piece. 
 * Melodies are calculated using the same conventions described for the Melodic Interval Histogram. Provides a 
 * measure of how close the wrapped melodic intervals as a whole are to the mean wrapped melodic interval.
 *
 * @author radamian
 */
