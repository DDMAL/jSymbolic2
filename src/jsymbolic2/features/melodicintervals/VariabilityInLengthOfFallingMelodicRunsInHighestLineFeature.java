		...
		extends MIDIFeatureExtractor
{
	...
	public VariabilityInLengthOfFallingMelodicRunsInHighestLineFeature()
	{
		...
		String code = "M-104";
		String description = "Standard deviation of the number of consecutive melodically falling notes that occur before a melodic change of direction in the MIDI channel with the highest average pitch, including the two end notes. Melodic unisons are not considered to break a run. Similar assumptions are made in the calculation of this feature as for the Melodic Interval Histogram. Set to 0 if no such runs are found.";
