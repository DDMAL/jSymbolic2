 ...
 * the highest note in runs of consecutive melodically falling notes. Melodic unisons are not considered to 
 * break a run. Similar assumptions are made in the calculation of this feature as for the Melodic Interval 
 * Histogram. Set to 0 if no melodic such runs are found.
 *
 * @author radamian and Cory McKay
 */
public class AverageIntervalSpannedByFallingMelodicRunsFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public AverageIntervalSpannedByFallingMelodicRunsFeature()
	{
		String name = "Average Interval Spanned by Falling Melodic Runs";
		String code = "M-78";
