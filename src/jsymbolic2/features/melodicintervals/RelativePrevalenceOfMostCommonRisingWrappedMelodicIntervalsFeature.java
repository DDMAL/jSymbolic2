...
/**
 * A feature calculator that finds the relative frequency of the second most common rising melodic interval in 
 * the piece, divided by the relative frequency of the most common rising wrapped melodic interval.
 *
 * @author radamian
 */
public class RelativePrevalenceOfMostCommonRisingWrappedMelodicIntervalsFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public RelativePrevalenceOfMostCommonRisingWrappedMelodicIntervalsFeature()
	{
		String name = "Relative Prevalence of Most Common Rising Wrapped Melodic Intervals";
		String code = "M-35";
		String description = "Relative frequency of the second most common rising melodic interval in the piece, divided by the relative frequency of the most common rising wrapped melodic interval.";
