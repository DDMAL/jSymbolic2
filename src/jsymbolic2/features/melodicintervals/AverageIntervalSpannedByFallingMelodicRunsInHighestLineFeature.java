 ...
 * the lowest note in runs of consecutive melodically falling notes in the MIDI channel with the highest 
 ...
 */
public class AverageIntervalSpannedByFallingMelodicRunsInHighestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public AverageIntervalSpannedByFallingMelodicRunsInHighestLineFeature()
	{
		String name = "Average Interval Spanned by Falling Melodic Runs in Highest Line";
		String code = "M-106";
		String description = "Average melodic interval (in semitones) separating the highest note and the lowest note in runs of consecutive melodically falling notes in the MIDI channel with the highest average pitch. Melodic unisons are not considered to break a run. Similar assumptions are made in the calculation of this feature as for the Melodic Interval Histogram. Set to 0 if no melodic such runs are found.";
