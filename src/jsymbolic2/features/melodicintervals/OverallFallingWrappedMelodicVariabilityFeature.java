...
/**
 * Standard deviation of the falling wrapped melodic intervals in the piece. Melodies are calculated using the 
 * same conventions described for the Wrapped Melodic Interval Histogram - Falling Intervals Only. Provides a 
