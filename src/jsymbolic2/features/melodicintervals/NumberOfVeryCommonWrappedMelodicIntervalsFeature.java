...
/**
 * Number of different melodic intervals that each account individually for at least 20% of all wrapped 
 * melodic intervals.
 *
 * @author radamian
 */
public class NumberOfVeryCommonWrappedMelodicIntervalsFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfVeryCommonWrappedMelodicIntervalsFeature()
	{
		String name = "Number of Very Common Wrapped Melodic Intervals";
		String code = "M-22";
		String description = "Number of different melodic intervals that each account individually for at least 20% of all wrapped melodic intervals.";
