...
/**
 * A feature calculator that finds the number of rising wrapped melodic intervals that occur at least once in 
 * the piece.
 *
 * @author radamian
 */
public class NumberOfRisingWrappedMelodicIntervalsFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfRisingWrappedMelodicIntervalsFeature()
	{
		String name = "Number of Rising Wrapped Melodic Intervals";
		String code = "M-15";
		String description = "Number of rising wrapped melodic intervals that occur at least once in the piece.";
