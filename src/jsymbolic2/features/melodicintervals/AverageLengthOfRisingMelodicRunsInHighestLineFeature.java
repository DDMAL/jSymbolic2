...
/**
 * A feature calculator that finds the mean number of consecutive melodically rising notes that occur before a
 * melodic change of direction in the MIDI track and channel with the highest average pitch, including the two
