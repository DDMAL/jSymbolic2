 ...
 * @author radamian
 */
public class MeanRisingWrappedMelodicIntervalFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public MeanRisingWrappedMelodicIntervalFeature()
	{
		String name = "Mean Rising Wrapped Melodic Interval";
		String code = "M-11";
		String description = "Mean average (in semitones) of the intervals involved in each of the rising melodic wrapped melodic intervals in the piece.";
