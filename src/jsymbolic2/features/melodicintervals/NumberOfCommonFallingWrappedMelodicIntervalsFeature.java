...
/**
 * A feature calculator that finds the number of different falling melodic intervals that each account 
 * individually for at least 9% of all falling wrapped melodic intervals.
 *
 * @author radamian
 */
