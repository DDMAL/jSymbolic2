 ...
 */
public class AmountOfFallingMelodicMotionFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public AmountOfFallingMelodicMotionFeature()
	{
		String name = "Amount of Falling Melodic Motion";
		String code = "M-72";
		String description = "Fraction of melodic intervals that are falling in pitch (repeated notes are not counted in this calculation). Set to zero if no rising or falling melodic intervals are found.";
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			if ((ups + downs) == 0)
				...
				value = (double) downs / ((double) (ups + downs));
		}
		else value = -1.0;
