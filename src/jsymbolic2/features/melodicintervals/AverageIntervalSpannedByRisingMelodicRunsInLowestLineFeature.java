 ...
 * the highest note in runs of consecutive melodically rising notes in the MIDI channel with the lowest 
 ...
 * @author radamian
 */
public class AverageIntervalSpannedByRisingMelodicRunsInLowestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public AverageIntervalSpannedByRisingMelodicRunsInLowestLineFeature()
	{
		String name = "Average Interval Spanned by Rising Melodic Runs in Lowest Line";
		String code = "M-133";
		String description = "Average melodic interval (in semitones) separating the lowest note and the highest note in runs of consecutive melodically rising notes in the MIDI channel with the lowest average pitch. Melodic unisons are not considered to break a run. Similar assumptions are made in the calculation of this feature as for the Melodic Interval Histogram. Set to 0 if no melodic such runs are found.";
