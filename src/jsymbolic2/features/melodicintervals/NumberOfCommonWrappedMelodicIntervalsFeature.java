 ...
 * @author radamian
 */
public class NumberOfCommonWrappedMelodicIntervalsFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfCommonWrappedMelodicIntervalsFeature()
	{
		String name = "Number of Common Wrapped Melodic Intervals";
		String code = "M-18";
		String description = "Number of different wrapped melodic intervals that each account individually for at least 9% of all wrapped melodic intervals.";
