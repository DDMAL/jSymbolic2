 ...
 * the highest average pitch that correspond to the most common melodic interval in the same MIDI track and
 * channel. Rising and falling intervals are treated as equivalent.
 *
 * @author radamian
 */
public class PrevalenceOfMostCommonMelodicIntervalInHighestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfMostCommonMelodicIntervalInHighestLineFeature()
	{
		String name = "Prevalence of Most Common Melodic Interval in Highest Line";
		String code = "M-96";
		String description = "Fraction of all melodic intervals in the MIDI track and channel with the highest average pitch that correspond to the most common melodic interval in the same MIDI track and channel. Rising and falling intervals are treated as equivalent.";
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			for (int i = 0; i < sequence_info.melodic_intervals_by_track_and_channel.get(track_with_highest_average_pitch)[channel_with_highest_average_pitch].size(); i++)
				melodic_intervals.add(sequence_info.melodic_intervals_by_track_and_channel.get(track_with_highest_average_pitch)[channel_with_highest_average_pitch].get(i));
