 ...
 * melodic interval in the in the MIDI channel with the highest average pitch. 
 *
 * @author radamian
 */
		...
		extends MIDIFeatureExtractor
{
	...
	public PrevalenceOfMostCommonMelodicIntervalInHighestLineFeature()
	{
		...
		String code = "M-96";
		String description = "Fraction of all melodic intervals that corresponds to the most common melodic interval in the in the MIDI channel with the highest average pitch.";
