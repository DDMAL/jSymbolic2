 ...
 * @author radamian
 */
public class AverageLengthOfRisingMelodicRunsInLowestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public AverageLengthOfRisingMelodicRunsInLowestLineFeature()
	{
		String name = "Average Length of Rising Melodic Runs in Lowest Line";
		String code = "M-129";
		String description = "Average number of consecutive melodically rising notes that occur before a melodic change of direction in the MIDI channel with the lowest average pitch, including the two end notes. Melodic unisons are not considered to break a run. Similar assumptions are made in the calculation of this feature as for the Melodic Interval Histogram. Set to 0 if no such runs are found.";
