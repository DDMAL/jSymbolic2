 ...
 * notes that occur before a melodic change of direction in the MIDI track and channel with the lowest average
 * pitch, including the two end notes. Melodic unisons are not considered to break a run. Similar assumptions
 * are made in the calculation of this feature as for the Melodic Interval Histogram. Set to 0 if no such runs
 * are found.
 *
 * @author radamian
 */
public class VariabilityInLengthOfFallingMelodicRunsInLowestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public VariabilityInLengthOfFallingMelodicRunsInLowestLineFeature()
	{
		String name = "Variability in Length of Falling Melodic Runs in Lowest Line";
		String code = "M-132";
		String description = "Standard deviation of the number of consecutive melodically falling notes that occur before a melodic change of direction in the MIDI track and channel with the lowest average pitch, including the two end notes. Melodic unisons are not considered to break a run. Similar assumptions are made in the calculation of this feature as for the Melodic Interval Histogram. Set to 0 if no such runs are found.";
