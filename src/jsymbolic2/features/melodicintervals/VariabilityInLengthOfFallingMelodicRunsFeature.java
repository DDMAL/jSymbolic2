 ...
 */
public class VariabilityInLengthOfFallingMelodicRunsFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public VariabilityInLengthOfFallingMelodicRunsFeature()
	{
		String name = "Variability in Length of Falling Melodic Runs";
		String code = "M-76";
		String description = "Standard deviation of the number of consecutive melodically falling notes that occur before a melodic change of direction, including the two end notes. Melodic unisons are not considered to break a run. Similar assumptions are made in the calculation of this feature as for the Melodic Interval Histogram. Set to 0 if no such runs are found.";
