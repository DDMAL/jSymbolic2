 ...
 * @author radamian
 */
public class WrappedMelodicIntervalHistogramRisingIntervalsOnlyFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public WrappedMelodicIntervalHistogramRisingIntervalsOnlyFeature()
	{
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			for (int bin = 0; bin < sequence_info.melodic_interval_histogram_rising_intervals_only.length; bin++)
				result[bin % 12] += sequence_info.melodic_interval_histogram_rising_intervals_only[bin];
		}
