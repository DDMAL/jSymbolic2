 ...
 * @author radamian
 */
public class LargestRisingMelodicIntervalFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public LargestRisingMelodicIntervalFeature()
	{
		String name = "Largest Rising Melodic Interval";
		String code = "M-50";
		String description = "The largest rising melodic interval in the piece.";
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			for (int bin = 0; bin < sequence_info.melodic_interval_histogram_rising_intervals_only.length; bin++)
				if (sequence_info.melodic_interval_histogram_rising_intervals_only[bin] > 0.0)
