 ...
 * the lowest note and the highest note in runs of consecutive melodically rising notes. Melodic unisons are 
 ...
 */
public class VariabilityInIntervalSpannedByRisingMelodicRunsFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public VariabilityInIntervalSpannedByRisingMelodicRunsFeature()
	{
		String name = "Variability in Interval Spanned by Rising Melodic Runs";
		String code = "M-79";
