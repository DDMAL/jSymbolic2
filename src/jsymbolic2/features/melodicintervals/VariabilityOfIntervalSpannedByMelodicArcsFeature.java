 ...
 * troughs and the bottom note of the next trough. Similar assumptions are made in the calculation of this 
 * feature as for the Melodic Interval Histogram.
 *
 * @author radamian and Cory McKay
 */
public class VariabilityOfIntervalSpannedByMelodicArcsFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public VariabilityOfIntervalSpannedByMelodicArcsFeature()
	{
		String name = "Variability of Interval Spanned by Melodic Arcs";
		String code = "M-87";
		String description = "Standard deviation of the melodic interval (in semitones) separating the top note of melodic peaks and the top note of the next peak, as well as the bottom note of melodic troughs and the bottom note of the next trough. Similar assumptions are made in the calculation of this feature as for the Melodic Interval Histogram.";
