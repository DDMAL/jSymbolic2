...
/**
 * A feature calculator that finds the ratio of wrapped melodic intervals that are dissonant (2nds, perfect 
 * 4ths, tritones, and 7ths) to wrapped horizontal intervals that are consonant (unisons, 3rds, perfect 5ths, 
 * 6ths and octaves). Set to 0 if there are no dissonant melodic intervals or no consonant melodic intervals.
 *
 * @author radamian
 */
public class MelodicDissonanceRatioFourthsDissonantFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public MelodicDissonanceRatioFourthsDissonantFeature()
	{
		String name = "Melodic Dissonance Ratio - Fourths Dissonant";
		String code = "M-67";
		String description = "Ratio of wrapped melodic intervals that are dissonant (2nds, perfect 4ths, tritones, and 7ths) to wrapped horizontal intervals that are consonant (unisons, 3rds, perfect 5ths, 6ths and octaves). Set to 0 if there are no dissonant melodic intervals or no consonant melodic intervals.";
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			fraction_dissonant_intervals += wrapped_melodic_histogram[5];
