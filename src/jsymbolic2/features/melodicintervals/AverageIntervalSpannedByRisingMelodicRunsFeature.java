 ...
 * the highest note in runs of consecutive melodically rising notes. Melodic unisons are not considered to 
 ...
 */
public class AverageIntervalSpannedByRisingMelodicRunsFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public AverageIntervalSpannedByRisingMelodicRunsFeature()
	{
		String name = "Average Interval Spanned by Rising Melodic Runs";
		String code = "M-77";
