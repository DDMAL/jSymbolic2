 ...
 * (including the notes at the peaks and troughs) in the MIDI channel with the highest average pitch. Similar
		...
		extends MIDIFeatureExtractor
{
	...
	public VariabilityInLengthOfMelodicArcsInHighestLineFeature()
	{
		...
		String code = "M-111";
		String description = "Standard deviation of the number of notes comprising melodic arcs (including the notes at the peaks and troughs) in the MIDI channel with the highest average pitch. Similar assumptions are made in the calculation of this feature as for the Melodic Interval Histogram. Set to 0 if no melodic arcs are found.";
