 ...
 * melodic peaks and consecutive melodic troughs in the MIDI channel with the highest average pitch. Similar 
 * assumptions are made in the calculation of this feature as for the Melodic Interval Histogram. Set to 0 if 
 * no melodic arcs are found.
 *
 * @author radamian and Cory McKay
 */
public class VariabilityInLengthOfMelodicArcsInHighestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public VariabilityInLengthOfMelodicArcsInHighestLineFeature()
	{
		String name = "Variability in Length of Melodic Arcs in Highest Line";
		String code = "M-111";
		String description = "Standard deviation of the number of notes that separate consecutive melodic peaks and consecutive melodic troughs in the MIDI channel with the highest average pitch. Similar assumptions are made in the calculation of this feature as for the Melodic Interval Histogram. Set to 0 if no melodic arcs are found.";
