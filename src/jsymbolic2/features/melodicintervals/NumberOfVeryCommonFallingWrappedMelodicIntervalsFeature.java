 ...
 * @author radamian
 */
public class NumberOfVeryCommonFallingWrappedMelodicIntervalsFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfVeryCommonFallingWrappedMelodicIntervalsFeature()
	{
		String name = "Number of Very Common Falling Wrapped Melodic Intervals";
		String code = "M-24";
		String description = "Number of different melodic intervals that each account individually for at least 20% of all falling wrapped melodic intervals.";
