...
/**
 * A feature calculator that finds the excess kurtosis of the melodic intervals in the piece. Melodic
		...
		extends MIDIFeatureExtractor
{
	...
	public OverallMelodicKurtosisFeature()
	{
		...
		String code = "M-43";
		String description = "Excess kurtosis of the melodic intervals in the piece. Melodies intervals are calculated using the same conventions described for the Melodic Interval Histogram. A higher kurtosis means that the tails are fatter and a lower kurtosis means that they are skinnier. A normal distribution has a value of 0. A distribution with a higher kurtosis is more likely to have extreme values.";
