 ...
 * @author radamian
 */
public class VariabilityInLengthOfRisingMelodicRunsInHighestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public VariabilityInLengthOfRisingMelodicRunsInHighestLineFeature()
	{
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			// Find the length of each rising melodic run for that track and channel
