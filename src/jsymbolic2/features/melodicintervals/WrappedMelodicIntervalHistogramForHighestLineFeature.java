 ...
 * considering melodic intervals in the voice with the highest average pitch. Entries for melodic intervals
 ...
 * intervals in the highest voice that are of the kind associated with the bin (this histogram is normalized).
 * Rising and falling intervals are treated as identical. If a given note onset slice for the highest voice
 * contains multiple pitches, then only the highest pitched note in the slice is counted for the purpose of
 * melody calculations. Also, if the highest note is sustained from one note onset slice to the next, and is
