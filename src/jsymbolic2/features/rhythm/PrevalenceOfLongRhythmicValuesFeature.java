		...
		extends MIDIFeatureExtractor
{
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			value = rhythmic_value_histogram[8] + rhythmic_value_histogram[9] + rhythmic_value_histogram[10] +
			        rhythmic_value_histogram[11] + rhythmic_value_histogram[12] + 
					rhythmic_value_histogram[13];
		}
		else value = -1.0;
