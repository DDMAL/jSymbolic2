 ...
 * in the last third of the tempo-standardized beat histogram.
 *
 * @author radamian
 */
public class PrevalenceOfFasterRhythmicPulsesTempoStandardizedFeature
		extends MIDIFeatureExtractor
{
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			for (int i = (2 * beat_histogram_standardized.length) / 3; i < beat_histogram_standardized.length; i++) // Last third of the histogram
			{
