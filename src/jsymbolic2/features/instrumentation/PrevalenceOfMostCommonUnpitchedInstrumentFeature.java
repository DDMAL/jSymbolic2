 ...
 * @author radamian
 */
public class PrevalenceOfMostCommonUnpitchedInstrumentFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfMostCommonUnpitchedInstrumentFeature()
	{
		String name = "Prevalance of Most Common Unpitched Instrument";
		String code = "I-17";
		...
		dependencies[0] = "Most Common Unpitched Instrument";
		offsets = null;
		is_default = true;
		is_secure = false;
	}
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			else
			{
				...
				value = (double) sequence_info.non_pitched_instrument_prevalence[most_common_instrument] / sequence_info.total_number_note_ons;
			}
		}
		else value = -1.0;
