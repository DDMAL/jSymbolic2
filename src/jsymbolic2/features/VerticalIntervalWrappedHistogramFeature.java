 ...
 */
public class VerticalIntervalWrappedHistogramFeature extends MIDIFeatureExtractor {

    public VerticalIntervalWrappedHistogramFeature()
    {
        String name = "Vertical Interval Wrapped Histogram";
