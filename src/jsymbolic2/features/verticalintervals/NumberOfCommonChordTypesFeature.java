 ...
 * feature) that each account individually for at least 9% of all chord types present.
 *
 * @author radamian
 */
public class NumberOfCommonChordTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfCommonChordTypesFeature()
	{
		String name = "Number of Common Chord Types";
		String code = "C-62";
		String description = "Number of distinct chord types (as defined by the Chord Type Histogram feature) that each account individually for at least 9% of all chord types present.";
