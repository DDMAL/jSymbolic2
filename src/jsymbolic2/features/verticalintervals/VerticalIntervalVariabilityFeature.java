 ...
 * weighted by the MIDI velocity at which it is played in the calculation of this feature.
 *
 * @author radamian
 */
		...
		extends MIDIFeatureExtractor
{
	...
	public VerticalIntervalVariabilityFeature()
	{
		...
		String code = "C-34";
		String description = "Standard deviation of the vertical intervals in the piece. Provides a measure of how close the vertical intervals as a whole are to the mean vertical interval. Unlike the calculation of Vertical Interval Histogram and its dependent features, each vertical interval is not weighted by the MIDI velocity at which it is played in the calculation of this feature.";
