 ...
 * corresponding to the most common vertical interval.
 *
 * @author radamian
 */
		...
		extends MIDIFeatureExtractor
{
	...
	public PrevalenceOfMostCommonVerticalIntervalFeature()
	{
		...
		String code = "C-28";
		String description = "Fraction of vertical intervals on the vertical interval histogram corresponding to the most common vertical interval.";
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			int max_index = mckay.utilities.staticlibraries.MathAndStatsMethods.getIndexOfLargest(vertical_interval_histogram);
			
			value = vertical_interval_histogram[max_index];		
		}
		else value = -1.0;
