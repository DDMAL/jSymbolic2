 ...
 * common melodic interval 3-gram type in the MIDI track and channel pairing with the highest average pitch in 
 ...
 * @author radamian
 */
public class PrevalenceOfMostCommonMelodicInterval3GramTypeInHighestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfMostCommonMelodicInterval3GramTypeInHighestLineFeature()
	{
		String name = "Prevalence of Most Common Melodic Interval 3-gram Type in Highest Line";
		String code = "NM-16";
		String description = "Fraction of all melodic interval 3-grams that correspond to the most common melodic interval 3-gram type in the MIDI track and channel pairing with the highest average pitch in the music. Set to 0 if there are no melodic interval 3-grams in this line (e.g. music with only MIDI Channel 10 unpitched notes).";
