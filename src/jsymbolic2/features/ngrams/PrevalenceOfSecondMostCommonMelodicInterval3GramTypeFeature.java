 ...
 * most common melodic interval 3-gram type. Set to 0 if there are no melodic interval 3-grams in the music 
 * (e.g. music with only MIDI Channel 10 unpitched notes).
 *
 * @author radamian
 */
public class PrevalenceOfSecondMostCommonMelodicInterval3GramTypeFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfSecondMostCommonMelodicInterval3GramTypeFeature()
	{
		String name = "Prevalence of Second Most Common Melodic Interval 3-gram Type";
		String code = "NM-4";
		String description = "Fraction of all melodic interval 3-grams that correspond to the second most common melodic interval 3-gram type. Set to 0 if there are no melodic interval 3-grams in the music (e.g. music with only MIDI Channel 10 unpitched notes).";
