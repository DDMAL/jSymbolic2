 ...
 * individually for 3% or less of all rhythmic value 3-grams that occur in the music.
 *
 * @author radamian
 */
public class NumberOfRareRhythmicValue3GramTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfRareRhythmicValue3GramTypesFeature()
	{
		String name = "Number of Rare Rhythmic Value 3-gram Types";
		String code = "NR-7";
		String description = "The number of different rhythmic value 3-gram types that each account individually for 3% or less of all rhythmic value 3-grams that occur in the music.";
