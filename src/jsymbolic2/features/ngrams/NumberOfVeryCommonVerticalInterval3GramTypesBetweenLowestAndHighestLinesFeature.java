 ...
 * for at least 10% of all vertical interval 3-grams that occur in the music.
 *
 * @author radamian
 */
public class NumberOfVeryCommonVerticalInterval3GramTypesBetweenLowestAndHighestLinesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfVeryCommonVerticalInterval3GramTypesBetweenLowestAndHighestLinesFeature()
	{
		String name = "Number of Very Common Vertical Interval 3-gram Types - Between Lowest and Highest Lines";
		String code = "NC-9";
		String description = "The number of vertical interval 3-gram types that each account individually for at least 10% of all vertical interval 3-grams that occur in the music.";
