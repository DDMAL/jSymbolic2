 ...
 * individually for at least 15% of all melodic interval 3-grams that occur in the music.
 *
 * @author radamian
 */
public class NumberOfVeryCommonMelodicInterval3GramTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfVeryCommonMelodicInterval3GramTypesFeature()
	{
		String name = "Number of Very Common Melodic Interval 3-gram Types";
		String code = "NM-9";
		String description = "The number of different melodic interval 3-gram types that each account individually for at least 15% of all melodic interval 3-grams that occur in the music.";
