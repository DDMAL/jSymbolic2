 ...
 * individually for at least 9% of all melodic interval 3-grams that occur in the MIDI track and channel 
 * pairing with the highest average pitch in the music.
 *
 * @author radamian
 */
public class NumberOfCommonMelodicInterval3GramTypesInHighestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfCommonMelodicInterval3GramTypesInHighestLineFeature()
	{
		String name = "Number of Common Melodic Interval 3-gram Types in Highest Line";
		String code = "NM-21";
		String description = "The number of different melodic interval 3-gram types that each account individually for at least 9% of all melodic interval 3-grams that occur in the MIDI track and channel pairing with the highest average pitch in the music.";
