...
/**
 * A feature calculator that finds the number of lowest and highest lines vertical interval 3-gram types that 
 * occur once and only once in the music, divided by the total number of unique lowest and highest lines 
 * vertical interval 3-gram types that exist in the music. Set to 0 if there are no lowest and highest lines 
 * vertical interval 3-grams in the music (e.g. music consisting only of a melody, or with only MIDI Channel 
 * 10 notes).
 *
 * @author radamian
 */
public class PrevalenceOfVerticalInterval3GramTypesOccurringOnlyOnceBetweenLowestAndHighestLinesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfVerticalInterval3GramTypesOccurringOnlyOnceBetweenLowestAndHighestLinesFeature()
	{
		String name = "Prevalence of Vertical Interval 3-gram Types Occurring Only Once - Between Lowest and Highest Lines";
		String code = "NC-10";
		String description = "The number of lowest and highest lines vertical interval 3-gram types that occur once and only once in the music, divided by the total number of unique lowest and highest lines vertical interval 3-gram types that exist in the music. Set to 0 if there are no lowest and highest lines vertical interval 3-grams in the music (e.g. music consisting only of a melody, or with only MIDI Channel 10 notes).";
