 ...
 * individually for 15% or more of all rhythmic value 3-grams that occur in the music, divided by the total 
 ...
 * @author radamian
 */
public class PrevalenceOfVeryCommonRhythmicValue3GramTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfVeryCommonRhythmicValue3GramTypesFeature()
	{
		String name = "Prevalence of Very Common Rhythmic Value 3-gram Types";
		String code = "NR-13";
		String description = "The number of different rhythmic value 3-gram types that each account individually for 15% or more of all rhythmic value 3-grams that occur in the music, divided by the total number of unique rhythmic value 3-gram types that exist in the music. Set to 0 if there are no rhythmic value 3-grams in the music (e.g. music with only MIDI Channel 10 unpitched notes).";
