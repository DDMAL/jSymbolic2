 ...
 * @author radamian
 */
public class PrevalenceOfRareMelodicInterval3GramTypesInHighestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfRareMelodicInterval3GramTypesInHighestLineFeature()
	{
		String name = "Prevalence of Rare Melodic Interval 3-gram Types in Highest Line";
		String code = "NM-24";
		String description = "The number of different melodic interval 3-gram types that each account individually for 3% or less of all melodic interval 3-grams that occur in the MIDI track and channel pairing with the highest average pitch in the music, divided by the total number of unique melodic interval 3-gram types that exist in this line. Set to 0 if there are no melodic interval 3-grams in this line (e.g. music with only MIDI Channel 10 unpitched notes).";
