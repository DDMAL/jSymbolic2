 ...
 * for 2% or more of all vertical interval 3-grams that occur in the music.
 *
 * @author radamian
 */
public class NumberOfVeryCommonVerticalInterval3GramTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfVeryCommonVerticalInterval3GramTypesFeature()
	{
		String name = "Number of Very Common Vertical Interval 3-gram Types";
		String code = "NC-20";
		String description = "The number of vertical interval 3-gram types that each account individually for 2% or more of all vertical interval 3-grams that occur in the music.";
