 ...
 * individually for 3% or less of all melodic interval 3-grams that occur in the music, divided by the total 
 ...
 * @author radamian
 */
public class PrevalenceOfRareMelodicInterval3GramTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfRareMelodicInterval3GramTypesFeature()
	{
		String name = "Prevalence of Rare Melodic Interval 3-gram Types";
		String code = "NM-11";
		String description = "The number of different melodic interval 3-gram types that each account individually for 3% or less of all melodic interval 3-grams that occur in the music, divided by the total number of unique melodic interval 3-gram types that exist in the music. Set to 0 if there are no melodic interval 3-grams in the music (e.g. music with only MIDI Channel 10 unpitched notes).";
