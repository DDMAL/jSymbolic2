 ...
 * @author radamian
 */
public class NumberOfRareVerticalInterval3GramTypesBetweenLowestAndHighestLinesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfRareVerticalInterval3GramTypesBetweenLowestAndHighestLinesFeature()
	{
		String name = "Number of Rare Vertical Interval 3-gram Types - Between Lowest and Highest Lines";
		String code = "NC-7";
		String description = "The number of different lowest and highest lines vertical interval 3-gram types that each account individually for 1% or less of all lowest and highest lines vertical interval 3-grams that occur in the music.";
