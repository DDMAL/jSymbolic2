 ...
 * individually for at least 9% of all melodic interval 3-grams that occur in the music.
 *
 * @author radamian
 */
public class NumberOfCommonMelodicInterval3GramTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfCommonMelodicInterval3GramTypesFeature()
	{
		String name = "Number of Common Melodic Interval 3-gram Types";
		String code = "NM-8";
		String description = "The number of different melodic interval 3-gram types that each account individually for at least 9% of all melodic interval 3-grams that occur in the music.";
