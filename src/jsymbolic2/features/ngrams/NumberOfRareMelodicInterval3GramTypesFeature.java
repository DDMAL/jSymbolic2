 ...
 * individually for 3% or less of all melodic interval 3-grams that occur in the music.
 *
 * @author radamian
 */
public class NumberOfRareMelodicInterval3GramTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfRareMelodicInterval3GramTypesFeature()
	{
		String name = "Number of Rare Melodic Interval 3-gram Types";
		String code = "NM-7";
		String description = "The number of different melodic interval 3-gram types that each account individually for 3% or less of all melodic interval 3-grams that occur in the music.";
