 ...
 * @author radamian
 */
public class NumberOfRareMelodicInterval3GramTypesInLowestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfRareMelodicInterval3GramTypesInLowestLineFeature()
	{
		String name = "Number of Rare Melodic Interval 3-gram Types in Lowest Line";
		String code = "NM-33";
		String description = "The number of different melodic interval 3-gram types that each account individually for 3% or less of all melodic interval 3-grams that occur in the MIDI track and channel pairing with the lowest average pitch in the music.";
