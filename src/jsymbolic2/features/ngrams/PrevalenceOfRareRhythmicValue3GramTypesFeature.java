 ...
 * individually for 3% or less of all rhythmic value 3-grams that occur in the music, divided by the total 
 ...
 * @author radamian
 */
public class PrevalenceOfRareRhythmicValue3GramTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfRareRhythmicValue3GramTypesFeature()
	{
		String name = "Prevalence of Rare Rhythmic Value 3-gram Types";
		String code = "NR-11";
		String description = "The number of different rhythmic value 3-gram types that each account individually for 3% or less of all rhythmic value 3-grams that occur in the music, divided by the total number of unique rhythmic value 3-gram types that exist in the music. Set to 0 if there are no rhythmic value 3-grams in the music (e.g. music with only MIDI Channel 10 unpitched notes).";
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
            ...
            if (!rhythmic_value_3gram_aggregate.noNGrams())
            {
                ...
                // Count number of rare rhythmic value 3-grams
