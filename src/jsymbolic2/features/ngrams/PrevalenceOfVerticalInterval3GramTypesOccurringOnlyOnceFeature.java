...
/**
 * A feature calculator that finds the number of complete vertical interval 3-gram types that occur once and 
 * only once in the music, divided by the total number of unique complete vertical interval 3-gram types that 
 * exist in the music. Set to 0 if there are no complete vertical interval 3-grams in the music (e.g. music 
 * consisting only of a melody, or with only MIDI Channel 10 notes).
 *
 * @author radamian
 */
public class PrevalenceOfVerticalInterval3GramTypesOccurringOnlyOnceFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfVerticalInterval3GramTypesOccurringOnlyOnceFeature()
	{
		String name = "Prevalence of Vertical Interval 3-gram Types Occurring Only Once";
		String code = "NC-21";
		String description = "The number of complete vertical interval 3-gram types that occur once and only once in the music, divided by the total number of unique complete vertical interval 3-gram types that exist in the music. Set to 0 if there are no complete vertical interval 3-grams in the music (e.g. music consisting only of a melody, or with only MIDI Channel 10 notes).";
