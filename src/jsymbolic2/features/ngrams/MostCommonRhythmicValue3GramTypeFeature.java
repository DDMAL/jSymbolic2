...
/**
 * A feature vector of size 3 consisting of the rhythmic value 3-gram that occurs the most frequently in the 
 * music. Each of the 3 component values of the 3-gram specifies a tempo-independent note duration in a 
 ...
 * @author radamian
 */
public class MostCommonRhythmicValue3GramTypeFeature
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
            ...
            if (!rhythmic_value_3gram_aggregate.noNGrams())
            {
                ...
                result = new double[most_common_rhythmic_value_3gram.size()];
                for (int i = 0; i < result.length; i++)
                    result[i] = most_common_rhythmic_value_3gram.get(i)[0];
            } else
