 ...
 * interval 3-gram type with the median prevalence in the MIDI track and channel pairing with the highest 
 ...
 * @author radamian
 */
public class PrevalenceOfMedianMelodicInterval3GramTypeInHighestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfMedianMelodicInterval3GramTypeInHighestLineFeature()
	{
		String name = "Prevalence of Median Melodic Interval 3-gram Type in Highest Line";
		String code = "NM-18";
		String description = "Fraction of all melodic interval 3-grams that correspond to the melodic interval 3-gram type with the median prevalence in the MIDI track and channel pairing with the highest average pitch in the music. Set to 0 if there are no melodic interval 3-grams in the music (e.g. music with only MIDI Channel 10 unpitched notes).";
