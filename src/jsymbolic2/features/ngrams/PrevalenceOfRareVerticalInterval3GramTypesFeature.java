 ...
 * @author radamian
 */
public class PrevalenceOfRareVerticalInterval3GramTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfRareVerticalInterval3GramTypesFeature()
	{
		String name = "Prevalence of Rare Vertical Interval 3-gram Types";
		String code = "NC-22";
		String description = "The number of different complete vertical interval 3-gram types that each account individually for 0.5% or less of all complete vertical interval 3-grams that occur in the music, divided by the total number of unique complete vertical interval 3-gram types that exist in the music. Set to 0 if there are no complete vertical interval 3-grams in the music (e.g. music consisting only of a melody, or with only MIDI Channel 10 notes).";
