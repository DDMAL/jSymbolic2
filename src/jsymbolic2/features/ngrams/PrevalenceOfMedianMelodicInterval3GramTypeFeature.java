		...
		extends MIDIFeatureExtractor
{
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
            ...
            {
                double[] frequencies_of_unique_ngrams = melodic_interval_3gram_aggregate.getFrequenciesOfUniqueNGrams();
            
                int index_of_median = mckay.utilities.staticlibraries.MathAndStatsMethods.getIndexOfMedian(frequencies_of_unique_ngrams);
                value = frequencies_of_unique_ngrams[index_of_median];
            }
		}
