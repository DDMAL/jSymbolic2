 ...
 * account individually for 1% or more of all complete vertical interval 3-grams that occur in the music, 
 ...
 * @author radamian
 */
public class PrevalenceOfCommonVerticalInterval3GramTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfCommonVerticalInterval3GramTypesFeature()
	{
		String name = "Prevalence of Common Vertical Interval 3-gram Types";
		String code = "NC-23";
		String description = "The number of different complete vertical interval 3-gram types that each account individually for 1% or more of all complete vertical interval 3-grams that occur in the music, divided by the total number of unique complete vertical interval 3-gram types that exist in the music. Set to 0 if there are no complete vertical interval 3-grams in the music (e.g. music consisting only of a melody, or with only MIDI Channel 10 notes).";
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
            ...
            if (!complete_vertical_interval_3gram_aggregate.noNGrams())
            {
                ...
                // Count number of common complete vertical interval 3-grams
