 ...
 * individually for at least 9% of all rhythmic value 3-grams that occur in the music.
 *
 * @author radamian
 */
public class NumberOfCommonRhythmicValue3GramTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfCommonRhythmicValue3GramTypesFeature()
	{
		String name = "Number of Common Rhythmic Value 3-gram Types";
		String code = "NR-8";
		String description = "The number of different rhythmic value 3-gram types that each account individually for at least 9% of all rhythmic value 3-grams that occur in the music.";
