 ...
 * @author radamian
 */
public class NumberOfCommonVerticalInterval3GramTypesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfCommonVerticalInterval3GramTypesFeature()
	{
		String name = "Number of Common Vertical Interval 3-gram Types";
		String code = "NC-19";
		String description = "The number of different complete vertical interval 3-gram types that each account individually for 1% or more of all complete vertical interval 3-grams that occur in the music.";
