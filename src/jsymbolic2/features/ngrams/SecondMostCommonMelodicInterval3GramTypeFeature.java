 ...
 * in the music. Each of the 3 component values of the 3-gram specifies a melodic interval in number of 
 * semitones, appearing in the order it occurs (e.g. the first value is the first melodic interval in the 
 * 3-gram). Only pitched notes are included in these 3-grams. Set to [0,0,0] if there are no melodic interval 
 * 3-grams in the music (e.g. music with only MIDI Channel 10 unpitched notes).
 *
 * @author radamian
 */
public class SecondMostCommonMelodicInterval3GramTypeFeature
