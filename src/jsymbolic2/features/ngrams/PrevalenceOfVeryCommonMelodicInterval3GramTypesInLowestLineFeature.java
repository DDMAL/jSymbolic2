 ...
 * pairing with the lowest average pitch in the music, divided by the total number of unique melodic interval 
 ...
 * @author radamian
 */
public class PrevalenceOfVeryCommonMelodicInterval3GramTypesInLowestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfVeryCommonMelodicInterval3GramTypesInLowestLineFeature()
	{
		String name = "Prevalence of Very Common Melodic Interval 3-gram Types in Lowest Line";
		String code = "NM-39";
		String description = "The number of different melodic interval 3-gram types that each account individually for 15% or more of all melodic interval 3-grams that occur in the MIDI track and channel pairing with the lowest average pitch in the music, divided by the total number of unique melodic interval 3-gram types that exist in this line. Set to 0 if there are no melodic interval 3-grams in this line (e.g. music with only MIDI Channel 10 unpitched notes).";
