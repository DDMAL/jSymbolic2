 ...
 * in the MIDI track and channel pairing with the lowest average pitch in the music, divided by the total 
 ...
 * @author radamian
 */
public class PrevalenceOfMelodicInterval3GramTypesOccurringOnlyOnceInLowestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public PrevalenceOfMelodicInterval3GramTypesOccurringOnlyOnceInLowestLineFeature()
	{
		String name = "Prevalence of Melodic Interval 3-gram Types Occurring Only Once in Lowest Line";
		String code = "NM-36";
		String description = "The number of melodic interval 3-gram types that occur once and only once in the MIDI track and channel pairing with the lowest average pitch in the music, divided by the total number of unique melodic interval 3-gram types that exist in this line. Set to 0 if there are no melodic interval 3-grams in this line (e.g. music with only MIDI Channel 10 unpitched notes).";
