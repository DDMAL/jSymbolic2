 ...
 * pairing with the lowest average pitch in the music.
 *
 * @author radamian
 */
public class NumberOfCommonMelodicInterval3GramTypesInLowestLineFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public NumberOfCommonMelodicInterval3GramTypesInLowestLineFeature()
	{
		String name = "Number of Common Melodic Interval 3-gram Types in Lowest Line";
		String code = "NM-34";
		String description = "The number of different melodic interval 3-gram types that each account individually for at least 9% of all melodic interval 3-grams that occur in the MIDI track and channel pairing with the lowest average pitch in the music.";
