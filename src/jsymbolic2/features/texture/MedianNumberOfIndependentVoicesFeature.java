...
/**
 * A feature calculator that finds the median number of different MIDI track/channel voices in which notes are 
 ...
 * @author radamian
 */
public class MedianNumberOfIndependentVoicesFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public MedianNumberOfIndependentVoicesFeature()
	{
		String name = "Median Number of Independent Voices";
		String code = "T-3";
		String description = "Median number of MIDI track/channel voices in which notes are sounded simultaneously. Rests are not included in this calculation. Set to 0 if there are no voices containing pitched notes.";
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			if (final_number_sounding == null || final_number_sounding.length == 0)
				...
				value = mckay.utilities.staticlibraries.MathAndStatsMethods.getMedianValue(final_number_sounding);
		}
		else value = -1.0;
