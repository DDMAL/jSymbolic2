...
/**
 * A feature calculator that finds the standard deviation of the number of different MIDI track/channel voices
 * in which notes are sounded simultaneously at each given moment (MIDI tick). Rests are not included in this 
 * calculation. Set to 0 if there are no voices containing pitched notes.
 *
		...
		extends MIDIFeatureExtractor
{
	...
	public VariabilityOfNumberOfIndependentVoicesFeature()
	{
		...
		String code = "T-4";
		String description = "Standard deviation of the number of different MIDI track/channel voices in which notes are sounded simultaneously at each given moment (MIDI tick). Rests are not included in this calculation. Set to 0 if there are no voices containing pitched notes.";
