 ...
 * with the highest average pitch, divided by the average melodic interval in all voices that contain at least 
 * two notes. Set to 0 if there are no voices containing melodic intervals.
 *
 * @author radamian
 */
public class RelativeSizeOfMelodicIntervalsInHighestVoiceFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public RelativeSizeOfMelodicIntervalsInHighestVoiceFeature()
	{
		String name = "Relative Size of Melodic Intervals in Highest Voice";
		String code = "T-18";
		String description = "Average melodic interval in semitones in the MIDI track/channel voice with the highest average pitch, divided by the average melodic interval in all voices that contain at least two notes. Set to 0 if there are no voices containing melodic intervals.";
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			{
				int avg_melodic_interval_in_highest_voice = sequence_info.track_and_channel_statistics[track_highest_voice][channel_highest_voice][3];
				...
				if (avg_melodic_interval_across_voices == 0)
					...
					value = (double) avg_melodic_interval_in_highest_voice / avg_melodic_interval_across_voices;
			}
