		...
		extends MIDIFeatureExtractor
{
	 ...
	 * The order and offsets of these features must be the same as those returned by this class'
	 * getDependencies and getDependencyOffsets methods, respectively. The first indice indicates the
