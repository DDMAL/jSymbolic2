 ...
 * saved during the next feature extraction. Provides methods to fill a table row by row. Makes all columns
 * except the first non-editable. The first column is filled with check boxes.
 *
 * @author Cory McKay
 */
	...
	extends DefaultTableModel
{
	 ...
	 * @param	column	The table column to check.
	 * @return			Whether or not the cell at the specified row and column are editable.
	 */
	@Override
